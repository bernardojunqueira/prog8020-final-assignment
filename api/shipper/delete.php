...
if (isset(apache_request_headers()['Authorization']) and $token->validate((apache_request_headers()['Authorization']))) {
    ...
    if ($shipper->delete()) {
        ...
        // tell the user
        echo json_encode(array("message" => "Shipper was deleted."));
    }
    // if unable to delete the shipper
    else {
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to delete shipper."));
    }
} else {
    // set response code
