...
if(isset(apache_request_headers()['Authorization']) and $token->validate((apache_request_headers()['Authorization']))){
    ...
    if(
        ...
        if($shipper->create()){
            ...
            // tell the user
            echo json_encode(array("message" => "Shipper was created."));
        }

        // if unable to create the shipper, tell the user
        else{
            ...
            // tell the user
            echo json_encode(array("message" => "Unable to create shipper."));
        }
    }
    ...
    // tell the user data is incomplete
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to create shipper. Data is incomplete."));
    }
